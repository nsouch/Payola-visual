...
class ClassDefSpecs extends CompilerIndependentSpec
{
    "Traits" should "can be declared" in {
        compileScalaCode(
            """
                package pkg
    ...
    "Classes" should "can be declared" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "can have getters and setters" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "can have implicit constructor" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "constructor can have body" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "can inherit from classes nad traits" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "parent constructor gets called properly" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "case classes are supported" in {
        compileScalaCode(
            """
    ...
    "Objects" should "can be declared" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "companion objects are supported" in {
        compileScalaCode(
            """
    ...
    "Package objects" should "can be declared using 'package object'" in {
        compileScalaCode(
            """
                package object po {
                    def m() { }
    ...
    it should "can be declared using '`package`' object name" in {
        compileScalaCode(
            """
                package pkg
    ...
    it should "don't override the package" in {
        compileScalaCode(
            """
                package pkg
