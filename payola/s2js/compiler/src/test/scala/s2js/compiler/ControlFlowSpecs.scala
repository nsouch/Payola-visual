...
class ControlFlowSpecs extends CompilerIndependentSpec
{
    "Loop statements" should "while is supported" in {
        compileScalaCode(
            """
    ...
    "If statements" should "are supported" in {
        compileScalaCode(
            """
                class o1 {
                    def m1() {
    ...
    it should "can return values" in {
        compileScalaCode(
            """
                import s2js.adapters.browser._
    ...
    it should "can have else if statements" in {
        compileScalaCode(
            """
                class o1 {
    ...
    "Exceptions" should "can be thrown" in {
        compileScalaCode(
            """
                class A {
                    def m() {
    ...
    it should "catch is supported" in {
        compileScalaCode(
            """
                class A {
                    def m() {
    ...
    it should "try/catch with return value is supported" in {
        compileScalaCode(
            """
                class A {
                    def m() {
    ...
    "Match statements" should "are supported" in {
        compileScalaCode(
            """
                class o {
                    def m() {
    ...
    it should "can have alternative patterns" in {
        compileScalaCode(
            """
                class o {
                    def m(): Int = {
    ...
    it should "typed patterns are supported" in {
        compileScalaCode(
            """
                class o {
                    def m(p: Any): Int = {
    ...
    it should "basic binding is supported" in {
        compileScalaCode(
            """
                class o {
                    def m(p: Any): Int = {
    ...
    it should "case class binding is supported" in {
        compileScalaCode(
            """
                class o {
                    def m(p: Any): Int = {
