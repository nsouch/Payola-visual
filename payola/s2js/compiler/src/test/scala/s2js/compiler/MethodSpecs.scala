...
class MethodSpecs extends CompilerIndependentSpec
{
    "Method calls" should "parentheses can be omitted" in {
        compileScalaCode(
            """
                object o1 {
                    def m: String = "foo"
    ...
    it should "default parameters are supported" in {
        compileScalaCode(
            """
                object o1 {
    ...
    it should "default parameters can reference fields" in {
        compileScalaCode(
            """
                object o1 {
                    val x = "o1"
    ...
    it should "can have a return value" in {
        compileScalaCode(
            """
                object a {
                    def m1() = {
    ...
    it should "generic methods can be called" in {
        compileScalaCode(
            """
                object a {
                    def m1[T](t: T) {}
    ...
    it should "can call a method of returned object" in {
        compileScalaCode(
            """
                class A {
    ...
    it should "can have multiple parameter lists" in {
        compileScalaCode(
            """
    ...
    it should "methods can have other methods as parameters" in {
        compileScalaCode(
            """
                import s2js.adapters.browser._
    ...
    it should "can override base class methods" in {
        compileScalaCode(
            """
                package $pkg
    ...
    it should "variadic methods are supported" in {
        compileScalaCode(
            """
                import s2js.adapters.browser._
